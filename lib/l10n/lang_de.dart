...
class LangDe extends Lang {
  ...
  @override
  String get ahBoth => ').\nSowohl für Entwickler als auch für Mitwirkende.';

  @override
  String get ahDescription =>
      'a11how vereinfacht die Übersetzung von .arb-basierten Apps (wie ';

  @override
  String get ahMagic => '...passiert die Magie!';

  @override
  String get ahSegway =>
      'Apropos, a11how ist in alle Software von YWT integriert.\nWenn du mit unseren nicht-englischen Inhalten interagierst und einen Fehler bemerkst, klicke einfach auf den Link unten auf der Seite und behebe ihn!\n\nSolange du ein GitHub-Konto hast, kannst du Änderungen mit einem Klick einreichen.';
  ...
  @override
  String get llDesign =>
      'Sein Design neigt zum Minimalismus, ist aber ausgestattet mit ';

  @override
  String get llFree =>
      ', denn eine gesunde Beziehung zur Technologie sollte nicht nur denen mit verfügbarem Einkommen vorbehalten sein.';

  @override
  String get llGit => 'auf GitHub';

  @override
  String get llModel => 'Liminal hat ein \"Zahl, was du kannst\"-Modell.\nDie ';

  @override
  String get llPaid =>
      '-Version kostet 4,99 \$, denn (guter) Code schreibt sich nicht von selbst.\nDie APK ist auch verfügbar ';

  @override
  String get llSlogan => 'Der letzte Launcher, den du jemals laden wirst.';

  @override
  String get llWhimsy =>
      'Dein Startbildschirm wird also frei von Unordnung und Ablenkungen sein UND sich grenzenlos anpassen lassen.\nMit einer Prise Verspieltheit obendrein.';
