...
class LangFr extends Lang {
  ...
  @override
  String get ahBoth =>
      ').\nÀ la fois pour les développeurs et les contributeurs.';

  @override
  String get ahDescription =>
      'a11how simplifie la traduction des applications basées sur .arb (comme ';

  @override
  String get ahMagic => '...la magie opère !';

  @override
  String get ahSegway =>
      'En parlant de cela, a11how est intégré dans tous les logiciels de YWT.\nSi vous interagissez avec notre contenu non anglophone et que vous remarquez une erreur, cliquez simplement sur le lien en bas de la page et corrigez-la !\n\nTant que vous possédez un compte GitHub, vous pouvez soumettre des modifications en un seul clic.';
  ...
  @override
  String get llFree =>
      ', car une relation saine avec la technologie ne devrait pas être réservée à ceux qui ont un revenu disponible.';

  @override
  String get llGit => 'sur GitHub';

  @override
  String get llModel =>
      'Liminal propose un modèle \"payez ce que vous pouvez\".\nLa ';

  @override
  String get llPaid =>
      ' version est à 4,99 \$, car le (bon) code ne s\'écrit pas tout seul.\nL\'APK est également disponible ';

  @override
  String get llSlogan => 'Le dernier launcher que vous installerez.';

  @override
  String get llWhimsy =>
      'Ainsi, votre écran d\'accueil sera libre de tout encombrement et distraction, ET sera personnalisable à l\'infini.\nAvec une touche de fantaisie en prime.';
