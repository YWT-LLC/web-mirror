...
class LangZh extends Lang {
  ...
  @override
  String get ahDescription => 'a11how 简化了基于 .arb 的应用程序翻译（例如 ';

  @override
  String get ahMagic => '...魔法在此发生！';

  @override
  String get ahSegway =>
      '顺便一提，a11how 已经集成到 YWT 的所有软件中。\n如果您在使用我们的非英文内容时发现任何错误，只需点击页面底部的链接即可进行修复！\n\n只要您拥有 GitHub 帐户，就可以一键提交更改。';
  ...
  @override
  String get llDesign => '其设计倾向于极简主义，但';

  @override
  String get llFree => '，因为与技术保持健康的关系不应仅仅是那些有闲钱的人的特权。';

  @override
  String get llGit => '在 GitHub 上';

  @override
  String get llModel => 'Liminal 采用“按需付费（pay what you can）”模式。\n';

  @override
  String get llPaid => ' 版本售价 4.99 美元，因为（好的）代码不会凭空出现。\nAPK 也可获取于 ';

  @override
  String get llSlogan => '您将安装的最后一款启动器。';

  @override
  String get llWhimsy => '因此，您的主屏幕将摆脱杂乱和干扰，并且支持无限个性化定制。\n更带有一丝奇思妙想。';
